...
class XiguaSource extends BaseSource {
  ...
  async search(keyword) {
    try {
      ...
      const detailUrl = `https://m.ixigua.com/video/6551332131417620995`;
      ...
      if (episodesMatch) {
        try {
          ...
          console.log('找到', playlistUrls.length, '集');
          ...
          console.error('解析episodes_list失败:', e);
        }
      } else {
        console.log('未找到episodes_list数据');
      }
