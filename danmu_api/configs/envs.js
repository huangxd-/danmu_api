...
export class Envs {
  ...
  static ALLOWED_PLATFORMS = ['qiyi', 'bilibili1', 'imgo', 'youku', 'qq', 'renren', 'hanjutv', 'bahamut', 'dandan', 'misaka']; // 全部源允许的播放平台
  static ALLOWED_SOURCES = ['360', 'vod', 'tmdb', 'douban', 'tencent', 'youku', 'iqiyi', 'imgo', 'bilibili', 'renren', 'hanjutv', 'bahamut', 'dandan', 'misaka']; // 允许的源
  ...
  static load(env = {}) {
    ...
    const envVarConfig = {
      ...
      'MISAKA_API_URL': { category: 'source', type: 'text', description: 'Misaka弹幕源API地址，默认https://misaka.bangumi.moe/api/v2' },
    ...
    return {
      ...
      misakaApiUrl: this.get('MISAKA_API_URL', 'https://misaka.bangumi.moe/api/v2', 'string'), // Misaka弹幕源API地址
